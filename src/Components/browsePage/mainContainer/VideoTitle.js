...
const VideoTitle = ({ handlePlayFullScreen, isPlaying, handlePause, trailerDescription, trailerId, handleMoreInfo, isMoreInfo, isvideoPlay, handlePlay, handleClose }) => {
  ...
  return (
    <div className="text-white absolute px-20 top-[28%]">
      ...
      <div className="my-4 md:m-0">
        ...
        {isMoreInfo && <MoreInfoPopUp trailerId={trailerId} trailerDescription={trailerDescription} isPlaying={isPlaying} handlePause={handlePause} isvideoPlay={isvideoPlay} handlePlay={handlePlay} handleClose={handleClose}/>}     
      </div>
    </div>
  )
}
